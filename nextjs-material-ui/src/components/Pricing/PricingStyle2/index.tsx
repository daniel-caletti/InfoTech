    ...
    <>
      <Grid container columnSpacing={{ xs: 1, sm: 2, md: 2, lg: 3 }}>
        <Grid item xs={12} sm={6} md={6} lg={4}>
          <div className={`mb-25 border-radius bg-white ${styles.pricingStyle2Card}`}>
            <div className={styles.cardContent}>
              <div className="text-center">
                ...
                <Typography component="span"fontWeight={500} display="block" mb="20px">
                  For individual user
                </Typography>
              </div>
              ...
              >
                <i className="material-symbols-outlined mr-5" style={{ fontSize: '16px' }}>arrow_forward_ios</i>
                Buy Now
              </Button>
