                ...
                <Grid item xs={12} md={12} lg={12} xl={12}>
                  <Box>
                    <FormControl>
                      ...
                      >
                        <FormControlLabel value="1" control={<Radio />} label="Only me" />
                        <FormControlLabel value="2" control={<Radio />} label="My followers" />
                        <FormControlLabel value="3" control={<Radio />} label="Everyone" />
                      </RadioGroup>
                    </FormControl>
                  </Box>
                </Grid>
          ...
          <Box component="form">
            ...
            >
              ...
              >
                <Grid item xs={12} md={12} lg={12} xl={12}>
                  <Box>
                    <FormControlLabel control={<Checkbox />} label="Allow users to show your email" />
                    <FormControlLabel control={<Checkbox />} label="Allow users to show your experiences" />
                    <FormControlLabel control={<Checkbox />} label="Allow users to show your followers" />
                  </Box>
                </Grid>
                  ...
                  <Box>
                    <FormControl>
                      ...
                      >
                        ...
                        <FormControlLabel value="2" control={<Radio />} label="Group Member" />
                      </RadioGroup>
                    </FormControl> 
                  </Box>
                </Grid>
