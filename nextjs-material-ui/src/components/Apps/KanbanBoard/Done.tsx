  ...
  return (
    <>
      ...
      >
        ...
        <Box>
          {doneListData &&
            doneListData.map((doneList, index) => (
              <Box
                className={`bg-purple-100 ${doneList.bgClass}`}
                sx={{
                  padding: "25px",
                  borderRadius: "7px",
                  marginBottom: "25px",
              ...
              >
                ...
                <Typography mb="15px">{doneList.description}</Typography>
                ...
                >
                  ...
                  >
                    {doneList.TeamMembers.map((member, i) => (
