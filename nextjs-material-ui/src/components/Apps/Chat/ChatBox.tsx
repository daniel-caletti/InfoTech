          ...
          <Box className={styles.chatBody}>
            <ul>
              ...
              <li className={styles.right}>
                ...
                <Typography component="span" className={styles.time}>09:20 AM</Typography>
              </li>
              ...
              <li className={styles.right}>
                ...
                <Typography component="span" className={styles.time}>09:21 AM</Typography>
              </li>
              ...
              <li>
                ...
                <Typography component="span" className={styles.time}>09:22 AM</Typography>
              </li>
              ...
              <li className={styles.right}>
                ...
                <Typography component="span" className={styles.time}>09:25 AM</Typography>
              </li>
              ...
              <li>
                ...
                <Typography component="span" className={styles.time}>09:30 AM</Typography>
              </li>
              ...
              <li className={styles.right}>
                ...
                <Typography component="span" className={styles.time}>09:31 AM</Typography>
              </li>
            </ul>
          </Box>
