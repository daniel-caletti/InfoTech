      ...
      <Grid container columnSpacing={{ xs: 1, sm: 2, md: 2, lg: 3 }}>
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/png.png" alt="png-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/jpg.png" alt="jpg-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/txt.png" alt="txt-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/pdf.png" alt="pdf-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/xl4.png" alt="xl4-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={3}>
          ...
          >
            ...
            >
              <Box>
                <Image src="/images/icons/doc.png" alt="doc-image" width={56} height={56} />
              </Box>
              <Typography
                fontWeight={700}
                fontSize="15px"
