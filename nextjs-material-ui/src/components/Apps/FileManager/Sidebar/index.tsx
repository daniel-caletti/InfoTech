          ...
          <ul className={styles.sidebarMenu}>
              ...
              <ul className="list-unstyled">
                <li>
                  <Link 
                    ...
                    className={`link ${
                      pathname === "/apps/file-manager/assets/" ? `${styles.active}` : ""
                    }`}
                  >
                    Assets
                  </Link>
                ...
                <li>
                  <Link 
                    ...
                    className={`link ${
                      pathname === "/apps/file-manager/projects/" ? `${styles.active}` : ""
                    }`}
                  >
                    Projects
                  </Link>
                ...
                <li>
                  <Link 
                    ...
                    className={`link ${
                      pathname === "/apps/file-manager/personal/" ? `${styles.active}` : ""
                    }`}
                  >
                    Personal
                  </Link>
                ...
                <li>
                  <Link 
                    ...
                    className={`link ${
                      pathname === "/apps/file-manager/applications/" ? `${styles.active}` : ""
                    }`}
                  >
                    Applications
                  </Link>
            ...
            <li>
              <Link 
                ...
                className={`link ${
                  pathname === "/apps/file-manager/documents/" ? `${styles.active}` : ""
                }`}
              >
                <i className="material-symbols-outlined text-success">description</i>
                Documents
              </Link>
            </li>
            ...
            <li>
              <Link 
                ...
                className={`link ${
                  pathname === "/apps/file-manager/media/" ? `${styles.active}` : ""
                }`}
              >
                <i className="material-symbols-outlined text-info">perm_media</i>
                Media
              </Link>
            </li>
            ...
            <li>
              <Link 
                ...
                className={`link ${
                  pathname === "/apps/file-manager/recents/" ? `${styles.active}` : ""
                }`}
              >
                <i className="material-symbols-outlined text-purple">schedule</i>
                Recents
              </Link>
            </li>
            ...
            <li>
              <Link 
                ...
                className={`link ${
                  pathname === "/apps/file-manager/important/" ? `${styles.active}` : ""
                }`}
              >
            ...
            <li>
              <Link href="#">
                <i className="material-symbols-outlined text-primary">report_gmailerrorred</i>
                Spam
