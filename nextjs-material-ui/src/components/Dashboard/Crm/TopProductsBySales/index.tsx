        ...
        <Box className="crm-sr-list">
          ...
          >
            ...
            >
              ...
              <Box>
                <Typography variant="h6" className="text-black" fontWeight="500 !important" fontSize="14px">
                  Samsung Galaxy
                </Typography>

                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>Samsung</Typography>
              </Box>
            </Box>

            <Typography component="div" color="success" fontWeight={500} className="text-black">
              $96,455
            </Typography>
          </Box>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>Apple inc.</Typography>
              </Box>
            </Box>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>Vivo Ltd.</Typography>
              </Box>
            </Box>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>Apple</Typography>
              </Box>
            </Box>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>Sony</Typography>
              </Box>
            </Box>
