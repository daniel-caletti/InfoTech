          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography component="span" mb="3px" sx={{ display: 'block' }}>Total Projects</Typography>
              ...
              >
                <Typography component="span" fontSize={13}>Projects this month</Typography>
          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography component="span" mb="3px" sx={{ display: 'block' }}>Active Projects</Typography>
          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography component="span" mb="3px" sx={{ display: 'block' }}>Finished Projects</Typography>
          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            >
              ...
              >
                ...
                <Box>
                  <Typography component="span" mb="3px" sx={{ display: 'block' }}>Team Members</Typography>
              ...
              >
                <Typography component="span" fontSize={13}>Hard Worker</Typography>
