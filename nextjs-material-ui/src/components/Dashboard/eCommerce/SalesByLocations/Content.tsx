      ...
      <Box>
        ...
        <Box>
          ...
          >
            ...
            <Box sx={{ flexGrow: "1" }}>
              <Typography component="span" sx={{ fontWeight: "500" }}>Germany</Typography>
          ...
          >
            ...
            <Box sx={{ flexGrow: "1" }}>
              <Typography component="span" sx={{ fontWeight: "500" }}>United Kingdom</Typography>
          ...
          >
            ...
            <Box sx={{ flexGrow: "1" }}>
              <Typography component="span" sx={{ fontWeight: "500" }}>Canada</Typography>
          ...
          >
            ...
            <Box sx={{ flexGrow: "1" }}>
              <Typography component="span" sx={{ fontWeight: "500" }}>Portugal</Typography>
          ...
          >
            ...
            <Box sx={{ flexGrow: "1" }}>
              <Typography component="span" sx={{ fontWeight: "500" }}>Spain</Typography>
