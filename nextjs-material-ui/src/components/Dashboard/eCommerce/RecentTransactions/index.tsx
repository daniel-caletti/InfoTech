      ...
      >
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Typography component="span" sx={{ fontSize: "13px", display: 'block' }}>
                  16 Jun 2024 - 7:12 pm
                </Typography>
              </Box>
            </Box>

            <Typography component="span" className="text-success">+1,520</Typography>
          </Box>
          ...
          >
            ...
            <Typography component="span" className="text-danger">-2,250</Typography>
          </Box>
          ...
          >
            ...
            <Typography component="span" className="text-success">+3,560</Typography>
          </Box>
          ...
          >
            ...
            >
              <Box
                className="text-secondary bg-secondary-100"
                sx={{
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
            ...
            <Typography component="span" className="text-success">+6,500</Typography>
          </Box>
          ...
          >
            ...
            <Typography component="span" className="text-danger">-4,320</Typography>
          </Box>
        </Box>
      </Card>
    </>
