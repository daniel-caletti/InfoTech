    ...
    <>
      ...
      >
        ...
        <Box>
          ...
          >
            <Typography component="span" sx={{ fontWeight: "500" }}>Completed Order</Typography>
          ...
          >
            <Typography component="span" sx={{ fontWeight: "500" }}>New Order</Typography>
          ...
          >
            <Typography component="span" sx={{ fontWeight: "500" }}>Pending Order</Typography>
