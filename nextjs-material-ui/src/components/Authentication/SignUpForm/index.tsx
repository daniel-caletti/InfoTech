            ...
            <Grid item xs={12} md={6} lg={6} xl={5}>
              ...
              >
                ...
                <Box component="form">
                  ...
                  >
                    By confirming your email, you agree to our <Link href="#" className="text-black" style={{ fontWeight: '500' }}>Terms of Service</Link> and that you have read and understood our <Link href="#" className="text-black" style={{ fontWeight: '500' }}>Privacy Policy</Link>.
                  </Typography>
