        ...
        <ul className={styles.appsMenuList}>
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Figma</Typography>
            </a>
          </li>
          ...
          <li>
            <a href="https://dribbble.com/" target="_blank" className="d-block">
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Dribbble</Typography>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Spotify</Typography>
            </a>
          </li>
          ...
          <li>
            <a href="https://gitlab.com/" target="_blank" className="d-block">
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Gitlab</Typography>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>GDrive</Typography>
            </a>
          </li>
          ...
          <li>
            <a href="https://trello.com/" target="_blank" className="d-block">
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Trello</Typography>
            </a>
          </li>
          ...
          <li>
            <a href="https://slack.com/" target="_blank" className="d-block">
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Slack</Typography>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Pinterest</Typography>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>Facebook</Typography>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <Typography sx={{ display: 'block', fontSize: '12px' }}>LinkedIn</Typography>
            </a>
          </li>
        </ul>
      </Menu>
