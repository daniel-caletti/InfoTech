        ...
        <div className="left-sidebar-menu">
          ...
          <div className="sidebar-inner">
            <div className="sidebar-menu">
                  ...
                  <ul className="sidebar-sub-menu">
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/ecommerce/orders/details/" ? "active" : ""
                        }`}
                      >
                        Order Details
                      </Link>
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/ecommerce/sellers/create/" ? "active" : ""
                        }`}
                      >
                        Create Seller
                      </Link>
                  ...
                  <ul className="sidebar-sub-menu">
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/project-management/project-overview/" ? "active" : ""
                        }`}
                      >
                        Project Overview
                      </Link>
                  ...
                  <ul className="sidebar-sub-menu">
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/lms/courses/lesson-preview/" ? "active" : ""
                        }`}
                      >
                        Lesson Preview
                      </Link>
                  ...
                  <ul className="sidebar-sub-menu">
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/authentication/forgot-password/" ? "active" : ""
                        }`}
                      >
                        Forgot Password
                      </Link>
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/authentication/reset-password/" ? "active" : ""
                        }`}
                      >
                        Reset Password
                      </Link>
                    ...
                    <li className="sidemenu-item">
                      <Link
                        ...
                        className={`sidemenu-link ${
                          pathname === "/authentication/confirm-email/" ? "active" : ""
                        }`}
                      >
                        Confirm Email
                      </Link>
              ...
              <Link href="/authentication/logout/" className="sidebar-menu-link">
