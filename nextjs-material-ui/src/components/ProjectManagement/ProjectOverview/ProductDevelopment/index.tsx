...
const ProductDevelopment: React.FC = () => {
  return (
    <>
      <Box className={`bg-white border-radius ${styles.productDevelopmentCard}`}>
        <Typography 
          variant="h5" 
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <i className="material-symbols-outlined" style={{ lineHeight: '45px' }}>for_you</i>
                </Box>
                <Box>
                  ...
                  <Typography variant="h6" className="text-white" fontWeight={600} fontSize="16px">
                    Innovatech
                  </Typography>
                </Box>
              </Box>
              ...
              >
                ...
                >
                  <i className="material-symbols-outlined" style={{ lineHeight: '45px' }}>attach_money</i>
                </Box>
                <Box>
                  <Typography className="text-white">
                    Budget
              ...
              >
                ...
                >
                  <i className="material-symbols-outlined" style={{ lineHeight: '45px' }}>pace</i>
                </Box>
                <Box>
                  <Typography className="text-white">
                    Duration
